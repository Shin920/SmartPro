<%@ Page Language="C#" MasterPageFile="~/MASTER/MasterPage.master" AutoEventWireup="true" CodeFile="DeptMaster.aspx.cs" Inherits="Common_Forms_DeptMaster" %>
<asp:Content ID="CommonContent" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <dx:ASPxGridView ID="Grid" ClientInstanceName="Grid" runat="server" Width="100%"
        ...
        KeyFieldName="DeptCode;DeptName" AutoGenerateColumns="false">

        <Settings ShowFooter="false" ShowGroupFooter="Hidden" HorizontalScrollBarMode="Auto" VerticalScrollBarMode="Auto" VerticalScrollableHeight="245" />
        ...
        <Columns>
            <dx:GridViewDataTextColumn FieldName="DeptCode" Caption="부서코드" Width="40%">
                <HeaderStyle HorizontalAlign="Center" /><CellStyle HorizontalAlign="Center" Wrap="False" />
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="DeptName" Caption="부서명" Width="60%">
                <HeaderStyle HorizontalAlign="Center" /><CellStyle HorizontalAlign="Center" Wrap="False" />
            </dx:GridViewDataTextColumn>
        </Columns>
    </dx:ASPxGridView>
    ...
    <dx:ASPxTextBox ID="txtCurDeptCode" ClientInstanceName="txtCurDeptCode" runat="server" ClientVisible="false"></dx:ASPxTextBox>
