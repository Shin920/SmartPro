<%@ Page Language="C#" MasterPageFile="~/MASTER/MasterPage.master" AutoEventWireup="true" CodeFile="UserGroupMaster.aspx.cs" Inherits="Common_Forms_UserGroupMaster" %>
...
<asp:Content ID="CommonContent" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <dx:ASPxGridView ID="Grid" ClientInstanceName="Grid" runat="server" Width="100%"
        ...
        KeyFieldName="UserGroup;GroupName" AutoGenerateColumns="false">
        ...
        <Columns>
            <dx:GridViewDataTextColumn FieldName="UserGroup" Caption="코드" Width="40%">
                <HeaderStyle HorizontalAlign="Center" /><CellStyle HorizontalAlign="Center" Wrap="False" />
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="GroupName" Caption="그룹명" Width="60%">
                <HeaderStyle HorizontalAlign="Center" /><CellStyle HorizontalAlign="Center" Wrap="False" />
            </dx:GridViewDataTextColumn>
        </Columns>
    </dx:ASPxGridView>
    ...
    <%-- 숨김필드 --%>
    <dx:ASPxTextBox ID="txtUserGroup" ClientInstanceName="txtItemGroup" runat="server" ClientVisible="false"></dx:ASPxTextBox>
    <dx:ASPxTextBox ID="txtGroupName" ClientInstanceName="txtGroupName" runat="server" ClientVisible="false"></dx:ASPxTextBox>
