<%@ Page Language="C#" MasterPageFile="~/MASTER/MasterPage.master" AutoEventWireup="true" CodeFile="AnnounceList.aspx.cs" Inherits="glb_SiteBoard_Announce_AnnounceList" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function btnNew_Click() {
            ...
            mastPopFormShow("공지사항 등록", "/SmartPro/glb/SiteBoard/Announce/AnnounceMng.aspx?Action=Load", 850, 570);
        }
        ...
        function GridDbClick(s, e) {
            ...
            if (sID != null) {
                ...
                v_mast_pop_callback = callbackMaster
                mastPopFormShow("공지사항 수정", "/SmartPro/glb/SiteBoard/Announce/AnnounceMng.aspx?Action=Load&ID=" + srID[0] + "&NUM=" + srID[1], 850, 570);
            }
        }
